...
- **Database**: Render-managed Postgres (`admissionmate-db`, free tier — **expires 2026-10-10**, will need upgrading or recreating)
...
| DB / Redis URLs | Render env vars, auto-wired from the linked Postgres/Redis resources |

## Known gaps / next things to watch

- Render Postgres free tier **expires 2026-10-10** — needs a plan before then or data is lost
