...
class User(Base):
    ...
    followed_exams: Mapped[list["FollowedExam"]] = relationship(back_populates="user", cascade="all, delete-orphan")
    study_goals: Mapped[list["StudyGoal"]] = relationship(back_populates="user", cascade="all, delete-orphan")
